...
import com.example.uts_empat_cina_map.ProfileFragment
...
class AdminReviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_review, container, false)
