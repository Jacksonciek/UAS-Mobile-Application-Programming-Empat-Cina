...
class AdminFoodItemDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addToCartButton.setOnClickListener {
            ...
            // Add or update the item in the cart with the specified quantity
            foodItem?.let { item ->
                CartManager.addOrUpdateCartItem(item, quantity)
        ...
        backButton.setOnClickListener {
            // Navigate to AdminItemFragment
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, AdminItemFragment())
                .addToBackStack(null)
                .commit()
        }
    }
